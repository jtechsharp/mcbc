...
using mcbc.Url;
using mcbc.Web.Public.Startup;
using mcbc.Web.Session;

namespace mcbc.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : mcbcViewComponent
    {
