    ...
    public static class AppSettings
    {
        ...
        public static class UiManagement
        {
            ...
            public static class Header
            {
                ...
                public const string NotificationIcon = "App.UiManagement.Header.NotificationIcon";
            }
        ...
        public static class TenantManagement
        {
            ...
            //extension
            public const string MaximumFileUploadSize = "App.TenantManagement.MaximumFileUploadSize";
            /// <summary>
            /// FileUploadQuota shall be feature, where a user can upload content of particular predeinded size
            /// </summary>
            public const string FileUploadQuota = "App.TenantManagement.FileUploadQuota";
            
            public const string AllowedMimeTypes = "App.TenantManagement.AllowedMimeTypes";
            public const string MaxConcurrentRequestsToHandle = "App.TenantManagement.MaxConcurrentRequestsToHandle";
            public const string AllowedFileTypes = "App.TenantManagement.AllowedFileTypes";
