...
namespace mcbc.Migrations
{
    ...
    [Migration("20220320064601_Changes in various entities-add")]
    partial class Changesinvariousentitiesadd
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("mcbc.Customization.Cause", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("mcbc.Customization.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("mcbc.Customization.Donation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("mcbc.Customization.MembershipRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("mcbc.Customization.NGO", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("mcbc.Customization.Sector", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("mcbc.Customization.UserFavoriteCause", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("mcbc.Customization.Cause", b =>
                {
                    b.HasOne("mcbc.Customization.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId");

                    b.HasOne("mcbc.Customization.NGO", null)
                        .WithMany("Causes")
                        .HasForeignKey("NGOId");

                    b.HasOne("mcbc.Customization.Sector", "Sector")
                        .WithMany()
            ...
            modelBuilder.Entity("mcbc.Customization.Donation", b =>
                {
                    b.HasOne("mcbc.Customization.Cause", "Cause")
                        .WithMany("Donations")
            ...
            modelBuilder.Entity("mcbc.Customization.NGO", b =>
                {
                    ...
                    b.HasOne("mcbc.MultiTenancy.Tenant", null)
                        .WithOne("NGO")
                        .HasForeignKey("mcbc.Customization.NGO", "TenantId");
