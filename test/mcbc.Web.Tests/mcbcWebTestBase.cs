...
{
    public abstract class mcbcWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static mcbcWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(mcbcWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<mcbcDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<mcbcDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<mcbcDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<mcbcDbContext, Task<T>> func)
        {
            T result;
